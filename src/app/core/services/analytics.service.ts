...
import { GreenhouseStatistics, GreenhouseStatus, TimeSeriesItem } from '../models/analytics.model';
...
export class AnalyticsService {
  ...
  getTimeSeries(
    greenhouseId: number = environment.defaultGreenhouseId,
    groupBy: 'day' | 'hour',
    startDate?: string,
    endDate?: string,
    node?: string
  ): Observable<ApiResponse<TimeSeriesItem[]>> {
